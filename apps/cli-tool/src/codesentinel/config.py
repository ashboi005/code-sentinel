...
def load_config(load_dotenv_files: bool = True) -> CliConfig:
    ...
    return CliConfig(
        ...
        openharness_max_turns=_read_int("CODESENTINEL_OPENHARNESS_MAX_TURNS", 20),
        openharness_allowed_tools=os.environ.get("CODESENTINEL_OPENHARNESS_ALLOWED_TOOLS", "bash,read_file,grep,glob"),
    )
